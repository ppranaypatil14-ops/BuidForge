...
def main():
    ...
    new_logo = '''<a href="/" class="flex items-center gap-2 group">
        ...
        <span class="text-white font-bold text-xl tracking-tight leading-none" style="font-family: -apple-system, BlinkMacSystemFont, 'Inter', sans-serif;">DepScan</span>
