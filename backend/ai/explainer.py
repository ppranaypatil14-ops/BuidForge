"""
AI-Powered Security Explainer & Auto-Remediation Generator for SupplyGuard.
...
logger = logging.getLogger("supplyguard.ai.explainer")
...
def _generate_expert_explanation(
    ...
    if not findings:
        ...
        summary = (
            f"SupplyGuard analyzed {len(findings)} security signals across {len(ecosystems)} ecosystems, "
