"""
Application Exception Hierarchy for SupplyGuard / Depscan.
...
class SupplyGuardError(Exception):
    """Base application exception for SupplyGuard."""
...
class RepositoryIngestionError(SupplyGuardError):
...
class ScannerError(SupplyGuardError):
...
class FirestoreError(SupplyGuardError):
...
class DocumentNotFoundError(SupplyGuardError):
...
class AuthenticationError(SupplyGuardError):
...
class RateLimitError(SupplyGuardError):
