"""
Centralized Error Handlers for SupplyGuard FastAPI Backend.
...
from backend.exceptions import SupplyGuardError

logger = logging.getLogger("supplyguard.error_handlers")
...
def register_error_handlers(app: FastAPI) -> None:
    ...
    @app.exception_handler(SupplyGuardError)
    async def supplyguard_error_handler(request: Request, exc: SupplyGuardError) -> JSONResponse:
        logger.warning(
