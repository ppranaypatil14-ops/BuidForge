"""
Repository Workspace Abstraction for SupplyGuard.
...
logger = logging.getLogger("supplyguard.ingestion.workspace")
...
class RepositoryWorkspace:
    ...
    def __init__(
        ...
        if workspace_dir is not None:
            ...
            self._root_path = Path(tempfile.mkdtemp(prefix="supplyguard_ws_")).resolve()
            self._is_temp = True
