"""
Tests for SupplyGuard / Depscan Domain and Persistence Models.
...
def test_repository_model():
    ...
    repo = Repository(
        url="https://github.com/supplyguard/demo-vuln",
        name="demo-vuln",
...
def test_domain_model_repository_integration():
    ...
    repository_meta = Repository(
        url="https://github.com/test/supplyguard-sample",
        name="supplyguard-sample",
    ...
    assert retrieved["repository"]["name"] == "supplyguard-sample"
